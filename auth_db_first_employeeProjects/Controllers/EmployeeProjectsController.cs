...
namespace auth_db_first_employeeProjects.Controllers
{
    public class EmployeeProjectsController : Controller
    {
        ...
        public EmployeeProjectsController(CompanyManagementContext context)
        {
            _context = context;
        }
        ...
        {
            var companyManagementContext = _context.EmployeeProjects.Include(e => e.Employee).Include(e => e.Project);
            return View(await companyManagementContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("EmployeeId,ProjectId,AssignedDate")] EmployeeProject employeeProject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,ProjectId,AssignedDate")] EmployeeProject employeeProject)
        {
